...
|===
| Commandes All-Access : privilèges minimum requis pour ONTAP 8.2._x_ et versions ultérieures 
...
|===
|===
| Commandes en lecture seule : privilèges minimum requis pour ONTAP 8.2._x_ et versions ultérieures 
