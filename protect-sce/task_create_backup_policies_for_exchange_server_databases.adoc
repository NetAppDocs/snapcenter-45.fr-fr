...
. Sur la page Retention, configurez les paramètres de rétention.
+
...
. Sur la page réplication, sélectionnez une ou les deux options de réplication secondaire suivantes :
+
|===
| Pour ce champ... | Procédez comme ça... 
