...
. Dans la page *fournir les détails de ressource*, effectuez les opérations suivantes :
+
|===
...
. Dans la page *Resource Settings*, indiquez des paires de clé-valeur personnalisées pour la ressource.
+
