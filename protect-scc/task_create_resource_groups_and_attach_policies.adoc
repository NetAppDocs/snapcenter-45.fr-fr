...
. Sur la page *Ressources*, cliquez sur Nouveau groupe de ressources.
...
|===
. Facultatif : sur la page *Ressources*, sélectionnez un nom d'hôte dans la liste déroulante *hôte* et le type de ressource dans la liste déroulante *Type de ressource*.
+
...
. Facultatif : sur la page *Paramètres d'application*, procédez comme suit :
+
