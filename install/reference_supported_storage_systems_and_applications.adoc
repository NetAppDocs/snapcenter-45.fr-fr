...
* SnapCenter prend en charge Amazon FSX pour NetApp ONTAP à partir de la version 4.5 des correctifs P1 du logiciel SnapCenter.
+
Si vous utilisez Amazon FSX pour NetApp ONTAP, assurez-vous que les plug-ins hôtes SnapCenter Server sont mis à niveau vers la version 4.5 P1 pour réaliser des opérations de protection des données.
...
+
Pour plus d'informations sur les applications et bases de données prises en charge, reportez-vous à la section https://mysupport.netapp.com/matrix/imt.jsp?components=100747;&solution=1257&isHWU&src=IMT["Matrice d'interopérabilité NetApp"^].
