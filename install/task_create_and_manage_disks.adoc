...
. Sur la page Nom de LUN, identifiez la LUN :
+
|===
...
|===
. Sur la page Propriétés du lecteur, spécifiez les propriétés du lecteur :
+
|===
...
|===
. Sur la page Résumé, vérifiez vos sélections, puis cliquez sur *Terminer*.
+
...
. Sur la page Nom de LUN, identifiez la LUN à connecter sur :
+
|===
| Dans ce champ... | Procédez comme ça... 
...
|===
. Sur la page Résumé, vérifiez vos sélections et cliquez sur *Terminer*.
+
