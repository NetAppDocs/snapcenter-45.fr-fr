...
. Sur la page *Ressources*, sélectionnez l'ancienne ressource MDC avec les sauvegardes ajoutées à la version précédente de SnapCenter et placez-la dans "mode de maintenance" à partir de la page topologie.
+
