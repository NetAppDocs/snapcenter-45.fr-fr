...
. Sur la page *Restore Scope*, sélectionnez l'une des options suivantes :
+
|===
| Option | Description 
...
|===
. Sur la page *opérations préalables*, effectuez les opérations suivantes :
+
...
. Sur la page *Post Ops*, effectuez les opérations suivantes :
+
